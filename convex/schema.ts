...
export default defineSchema({
  ...
  routineExercises: defineTable({
    ...
    repRangeMin: routineExerciseRowValidator.fields.repRangeMin,
    repRangeMax: routineExerciseRowValidator.fields.repRangeMax,
  ...
  workoutSessionExercises: defineTable({
    ...
    repRangeMin: workoutSessionExerciseRowValidator.fields.repRangeMin,
    repRangeMax: workoutSessionExerciseRowValidator.fields.repRangeMax,
