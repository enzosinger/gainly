        ...
        <Card>
          <CardContent className="space-y-4 p-6">
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-[hsl(var(--foreground))]">No routines yet</h2>
              <p className="text-sm text-[hsl(var(--muted-foreground))]">
                Create your first routine to start tracking weekly completion and workout progress.
              </p>
            </div>
            <Link to="/routines" className="inline-flex">
              <Button variant="outline">Go to routines</Button>
            </Link>
          </CardContent>
        </Card>
      ) : (
