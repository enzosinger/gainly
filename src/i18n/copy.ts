...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      inactiveTitle: "No active routines",
      inactiveBody: "Reactivate a routine to bring it back into this week's rotation.",
    ...
    routines: {
      ...
      duplicateRoutineButton: (name: string) => `Duplicate ${name} routine`,
      deactivateRoutineButton: (name: string) => `Deactivate ${name} routine`,
      activateRoutineButton: (name: string) => `Activate ${name} routine`,
      editRoutineNameButton: (name: string) => `Edit ${name} routine name`,
      cancelRenameRoutineButton: (name: string) => `Cancel ${name} routine name edit`,
      saveRenameRoutineButton: (name: string) => `Save ${name} routine name`,
    ...
    builder: {
      ...
      reorderExercise: (index: number) => `Reorder exercise ${index}`,
  ...
  pt: {
    ...
    dashboard: {
      ...
      inactiveTitle: "Nenhuma rotina ativa",
      inactiveBody: "Reative uma rotina para trazê-la de volta para a rotação da semana.",
    ...
    routines: {
      ...
      duplicateRoutineButton: (name: string) => `Duplicar rotina ${name}`,
      deactivateRoutineButton: (name: string) => `Desativar rotina ${name}`,
      activateRoutineButton: (name: string) => `Ativar rotina ${name}`,
      editRoutineNameButton: (name: string) => `Editar nome da rotina ${name}`,
      cancelRenameRoutineButton: (name: string) => `Cancelar edição do nome da rotina ${name}`,
      saveRenameRoutineButton: (name: string) => `Salvar nome da rotina ${name}`,
    ...
    builder: {
      ...
      reorderExercise: (index: number) => `Reorganizar exercício ${index}`,
